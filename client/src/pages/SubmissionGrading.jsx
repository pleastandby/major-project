...
const SubmissionGrading = () => {
    ...
    const [activeTab, setActiveTab] = useState('grading'); // 'ocr', 'grading', or 'key'
            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className="w-1/2 bg-white dark:bg-[#09090b] flex flex-col h-full overflow-hidden">
                    ...
                    <div className="flex border-b border-gray-200 dark:border-white/5">
                        ...
                        {submission.assignmentId?.answerKey && (
                            <button
                                className={`flex-1 py-3 text-sm font-medium border-b-2 transition-colors ${activeTab === 'key' ? 'border-primary text-primary' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'}`}
                        ...
                        {activeTab === 'key' && (
                            <div className="space-y-4">
                                <div className="bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-100 dark:border-yellow-900/30 rounded-lg p-4">
                                    <div className="flex gap-3">
                                        <FileText className="text-yellow-600 shrink-0 mt-0.5" size={20} />
                                        <div>
                                            <h3 className="font-semibold text-yellow-900 dark:text-yellow-100 text-sm">Reference Answer Key</h3>
                                            <p className="text-xs text-yellow-700 dark:text-yellow-300 mt-1">
                                                This key was generated by AI during assignment creation. Use it as a reference for grading.
                                            </p>
                                        </div>
                                    </div>
                                </div>

                                <div className="p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 text-sm text-gray-800 dark:text-gray-200">
                                    <div className="prose prose-sm dark:prose-invert max-w-none">
                                        <ReactMarkdown>{submission.assignmentId?.answerKey}</ReactMarkdown>
                                    </div>
                                </div>
                            </div>
                        )}
