...
const NotificationList = () => {
    ...
    const getLevelStyles = (level) => {
        switch (level) {
            case 'red': return 'bg-red-50 border-red-100 text-red-900 icon-red';
            case 'yellow': return 'bg-yellow-50 border-yellow-100 text-yellow-900 icon-yellow';
            case 'green':
                            ...
                            <div className="flex justify-between items-start gap-4">
                                <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-1">
                                        <span className={`text-xs px-2 py-0.5 rounded-full font-medium uppercase tracking-wide border ${notif.type === 'admin' ? 'bg-purple-100 text-purple-700 border-purple-200' :
                                                notif.type === 'system' ? 'bg-blue-100 text-blue-700 border-blue-200' :
